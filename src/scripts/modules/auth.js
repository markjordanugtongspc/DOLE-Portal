        ...
        <section id="${prefix}-register-panel" class="w-1/2 shrink-0 ${isMobile ? '' : 'pl-8'}">
            ...
            <form id="${prefix}-register-form" class="space-y-5 text-left">
                ...
                <div id="${prefix}-register-step-0" data-register-step="0" class="space-y-4">
                    ...
                    <div id="${prefix}-register-office-wrapper" class="relative z-30"><label class="block mb-1.5 text-xs font-bold text-blue-700 dark:text-blue-500 uppercase tracking-wide">Office</label><input type="hidden" id="${prefix}-register-office"><button type="button" id="${prefix}-register-office-dropdown-btn" class="cursor-pointer bg-gray-50 border border-gray-300 text-gray-900 text-sm ${rounded} focus:ring-2 focus:ring-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-700 dark:text-white text-left flex justify-between items-center"><span>Loading offices...</span><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m19 9-7 7-7-7"></path></svg></button><div id="${prefix}-register-office-dropdown-list" class="absolute left-0 right-0 z-[9999] mt-1 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 ${rounded} shadow-2xl hidden"><div class="border-b border-gray-200 dark:border-gray-700 p-2"><input type="text" id="${prefix}-register-office-search" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white text-xs" placeholder="Search offices..." autocomplete="off"></div><div class="options-container max-h-48 overflow-y-auto p-1"></div></div></div>
...
/* START INIT REGISTER OFFICE DROPDOWN - Populates and handles custom searchable office selection */
...
/* END INIT REGISTER OFFICE DROPDOWN */
