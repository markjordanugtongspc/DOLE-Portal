 ...
 *
 * @param {object} payload  â€” { created_by, category_id, subject, priority, team, tags }
 * @returns {{ data: object|null, error: string|null }}
 */
...
/**
 * Open a ticket â€” sets status to 'Open' and clears unread count.
...
/**
 * Close a ticket â€” sets status to 'Closed'.
 * @param {number} ticketId
 * @returns {{ error: string|null }}
 */
 ...
 * @param {number} userId  â€” The ID of the logged-in staff/HR user
 * @param {object} filters â€” { category_id, priority, status }
 * @returns {{ data: Array, error: string|null }}
 */
